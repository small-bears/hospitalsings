...
(协同过滤推荐算法+AI智能助手)基于SpringBoot的机票管理系统与实现分为管理员模块和用户模块，具体功能如下：

（1）管理员模块：系统首页、用户管理、机票信息管理、机票预订管理、取消预订管理、服务类型管理、附加服务管理、服务预订管理、积分商品管理、积分兑换管理、弹窗提醒管理、系统管理、航班时刻表管理、个人中心
（2）用户模块：首页、航班时刻表查询、机票信息查询、附加服务管理、积分商品管理、机票资讯、个人中心（含修改密码、订单信息、民宿预订、我的发布、我的收藏）
